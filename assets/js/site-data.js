...
const BLOG_ARTICLES = {
  'huong-dan-dung-bep-xong-thao-moc': {
    ...
    sections: [
      ...
      { type: 'image', src: './deploy/bep-xong-thao-moc-phuong-lam-assets/bep-xong-thao-moc-san-pham-chinh.png', alt: 'Hình ảnh bếp xông thảo mộc chính hãng Nến Phương Lâm', caption: 'Bếp xông thảo mộc kết hợp vỏ bưởi, sả và quế cho hương thơm ấm dịu.' },
      ...
      { type: 'image', src: './deploy/bep-xong-thao-moc-phuong-lam-assets/cach-chon-nen-tealight-cho-bep-xong.png', alt: 'Cách chọn nến tealight phù hợp cho bếp xông thảo mộc', caption: 'Nến tealight phù hợp giúp bếp xông tỏa nhiệt ổn định và an toàn hơn.' },
      ...
      { type: 'image', src: './deploy/bep-xong-thao-moc-phuong-lam-assets/cach-dung-bep-xong-thao-moc-an-toan.png', alt: 'Cách dùng bếp xông thảo mộc đúng cách và an toàn tại nhà', caption: 'Đặt bếp xông trên bề mặt chịu nhiệt, xa vật dễ cháy và luôn quan sát khi nến đang cháy.' },
      ...
      { type: 'image', src: './deploy/bep-xong-thao-moc-phuong-lam-assets/luu-y-an-toan-bep-xong-thao-moc.png', alt: 'Lưu ý an toàn khi sử dụng bếp xông thảo mộc đất nung', caption: 'Bảo quản bếp đất nung nơi khô ráo và vệ sinh nhẹ bằng khăn khô sau khi dùng.' },
