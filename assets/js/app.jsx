...
const ProductPage = ({ productId, setPage, goBack, addToCart, productImages = {} }) => {
  ...
  const optionFallbackImgs = optionGroups
    ...
    .filter(Boolean);
  const galleryImgs = uploadedImgs.length ? uploadedImgs : optionFallbackImgs.length ? optionFallbackImgs : variantFallbackImgs;
                ...
                <div key={group.name} style={{ marginBottom: 14 }}>
                  ...
                  <div style={isColorOptionGroup(group) ? ppStyles.colorGrid : ppStyles.variantGrid}>
                    {group.values.map(value => {
                      ...
                      const previewImage = !isColor ? (getOptionImage(group.name, value) || previewVariant?.image) : '';
                      return (
                        <button
                          key={value}
