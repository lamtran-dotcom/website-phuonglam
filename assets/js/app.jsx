      ...
      <section style={{ ...hpStyles.section, background: '#fff', padding: isMobile ? '40px 0' : '64px 0' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto', padding: isMobile ? '0 16px' : '0 24px' }}>
          ...
          <div
            ...
            style={{ display: 'flex', gap: isMobile ? 12 : 14, overflowX: 'auto', scrollSnapType: 'x mandatory', paddingBottom: 4 }}
          >
            {bestsellers.map(p => (
          ...
          {/* Arrows + View all — căn giữa cùng 1 hàng */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, marginTop: 32 }}>
            {!isMobile && (
              <button
                style={hpStyles.carouselBtn}
