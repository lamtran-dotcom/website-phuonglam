...
const BAKED_HEADER_IMAGES = /*BAKED_HEADER_IMAGES*/["/assets/media/generated/embedded-002.jpg","/assets/media/generated/embedded-003.jpg","/assets/media/generated/embedded-004.jpg","/assets/media/generated/embedded-008.jpg","/assets/media/generated/embedded-005.jpg","/assets/media/generated/embedded-009.webp"]/*END_BAKED_HEADER_IMAGES*/;

const BLOG_IMAGE_MAP = {
  'huong-dan-dung-bep-xong-thao-moc': './deploy/bep-xong-thao-moc-phuong-lam-assets/featured-bep-xong-thao-moc-phuong-lam.png',
  'phan-biet-nen-tealight-nen-2h-4h-8h': './anh-bai-viet/nen-tealight-khong-khoi-featured.png',
  'cach-xong-thao-moc-dung-cach': './thảo mộc.jpg',
  'nen-tealight-xong-nha-cach-dung': './nến tealight.jpeg',
  'top-5-thao-moc-xong-mua-dong': './thảo mộc.jpg',
  'xong-nha-thao-moc-co-diet-khuan-khong': './thảo mộc.jpg',
  'combo-xong-nha-cho-nguoi-moi': './bộ xông cao cấp.jpg',
  'ngai-cuu-xong-hoi-tac-dung-cach-dung': './thảo mộc.jpg',
  'sa-gung-xong-nha-duoi-muoi': './thảo mộc.jpg',
  'bep-xong-tinh-dau-gom-loai-nao-tot': './đèn xông tinh dầu.jpg',
  'xong-thao-moc-sau-sinh-loi-ich': './tinh dầu.jpg',
};

const getBlogImage = (slug) => BLOG_IMAGE_MAP[slug] || null;
...
const ProductPage = ({ productId, setPage, goBack, addToCart, productImages = {} }) => {
  ...
  }, [product.id, variantSignature, selectedVariantId]);

  const handleAddToCart = (event) => {
    animateAddToCart(event?.currentTarget, selectedVariant?.image || displayImgs[activeImg] || getProductDisplayImage(product, productImages));
  ...
  const galleryImgs = uploadedImgs.length ? uploadedImgs : variantFallbackImgs;
...
const BAKED_CATEGORY_IMAGES = /*BAKED_CATEGORY_IMAGES*/{"nen-thom":"/assets/media/generated/embedded-018.webp","combo":"/assets/media/generated/embedded-026.webp","thao-moc-xong":"/assets/media/generated/embedded-027.webp","bep-xong":"/assets/media/generated/embedded-028.webp","nu-tram":"/assets/media/generated/embedded-029.webp","phu-kien":"/assets/media/generated/embedded-009.webp"}/*END_BAKED_CATEGORY_IMAGES*/;
const BAKED_FEATURED = /*BAKED_FEATURED*/["shopee_29011454025","1","shopee_17395821074","new_1776857467847","shopee_7510227721","shopee_54450013830","shopee_57058955812"]/*END_BAKED_FEATURED*/;
...
const App = () => {
  ...
  const [serverProducts, setServerProducts] = React.useState(null);
  ...
  const effectiveProducts = Array.isArray(serverProducts) && serverProducts.length > 0
    ? serverProducts
    : [...mergedProducts, ...extraProducts];
  window.PRODUCTS_LIVE = effectiveProducts;

  const effectiveFeaturedIds = serverSettings?.featuredIds?.length ? serverSettings.featuredIds : featuredIds;
  const effectiveHeaderImages = serverSettings?.headerImages?.length ? serverSettings.headerImages : headerImages;
  const effectiveCategoryImages = serverSettings?.categoryImages && Object.keys(serverSettings.categoryImages).length
    ? serverSettings.categoryImages
    : categoryImages;
