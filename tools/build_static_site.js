...
body { margin: 0; font-family: system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; color: var(--seo-text); background: #fff; line-height: 1.65; }
a { color: inherit; }
...
.seo-main { max-width: 1120px; margin: 0 auto; padding: 20px; }
.breadcrumb { font-size: 13px; color: var(--seo-muted); margin: 0 0 18px; }
.breadcrumb a { color: var(--seo-muted); text-decoration: none; }
.product-layout { display: grid; grid-template-columns: minmax(280px, 480px) 1fr; gap: 40px; align-items: start; }
...
h1 { font-size: clamp(30px, 5vw, 52px); line-height: 1.08; margin: 0 0 16px; letter-spacing: -.02em; }
...
.summary, .content { color: #334833; font-size: 17px; }
